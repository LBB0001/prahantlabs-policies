# PrahantLabs — app policies

The privacy policy and terms for PrahantLabs apps, published so they have a
public address for store listings.
...
These two stay at the root, because that is the address already on the store
listing. Everything added after them lives in a folder of its own.
